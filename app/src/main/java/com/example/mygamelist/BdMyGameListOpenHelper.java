...
public class BdMyGameListOpenHelper extends SQLiteOpenHelper {

    public static final String NOME_BASE_DADOS = "mygameslist.db";
    ...
    public BdMyGameListOpenHelper(@Nullable Context context) {
